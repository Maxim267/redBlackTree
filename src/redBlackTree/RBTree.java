...
public class RBTree extends BSTree {
    /**
     * Конструктор класса {@code RBTree}
     */
    public RBTree() {
    ...
    /**
     * Проверить и при необходимости внести изменения в окраску узлов дерева ПОСЛЕ добавления узла
     * @param node узел - который может образовать красную линию на противоположной стороне дерева от стороны поворота красной линий
     */
