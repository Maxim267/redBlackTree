...
public class IntDisplay extends BaseDisplay {
     ...
     * @param blanks 2^N значение количества пробелов позиционирования дерева, начиная с корневого узла дерева.
     ...
     *              Не 2^N значение {@code blanks} будет автоматически преобразовано к ближайшему 2^N значению (вверх или вниз).
     */
